...
@Component({
  selector: 'app-sphere',
  templateUrl: './atomic-structure.component.html',
  styleUrls: ['./atomic-structure.component.css']
})
export class AtomicStructureComponent implements OnInit, AfterViewInit, OnDestroy {
